...
// asTopMem.sv – Pipeline cache version (RV_PipelineCache)
//
// Identical to RV_NoPipelineCache/src/asTopMem.sv except:
//   - as_cpux replaced by cc_cpupipe (5-stage pipeline CPU, Step 1: stall-only).
`timescale 1ns/1ps
