...
\begin{tabularx}{\textwidth}{|l |l |l |l |X|}
  \hline
  Base Address & End Address & Peripheral & AW & Notes \\
  \hline
  \hline
  \multicolumn{5}{|l|}{\textit{Main memory (bit 32 = 0)}} \\
  \hline
  \texttt{0x0000\_0000\_0000\_0000} & \texttt{0x0000\_0000\_0000\_FFFF}
    & D-Mem / Scratchpad & --- & 64\;kB.
      \textit{RV\_NoPipeline}: flat SRAM.
      \textit{RV\_NoPipelineCache}: scratchpad (SP\_BASE\,=\,0). \\
  \hline
  \multicolumn{5}{|l|}{\textit{Peripheral bus (bit 32 = 1, prefix 0x0000\_0001)}} \\
  \hline
  \texttt{0x0000\_0001\_0000\_0000} & \texttt{0x0000\_0001\_0000\_01FF}
    & \textbf{GPIO0} & 7 & 512\;B, cs[1]. Both project variants. \\
  \hline
  \texttt{0x0000\_0001\_0000\_0200} & \texttt{0x0000\_0001\_0000\_03FF}
    & \textbf{QSPI0} & 8 & 512\;B, cs[2]. \textit{RV\_NoPipelineCache} only. \\
  \hline
  \texttt{0x0000\_0001\_0000\_0400} & \texttt{0x0000\_0001\_0000\_05FF}
    & \textbf{CGU} & 4 & 512\;B, cs[3]. Both project variants. \\
  \hline
  \texttt{0x0000\_0001\_0000\_0600} & \texttt{0x0000\_0001\_0000\_07FF}
    & \textbf{UART0} & 8 & 512\;B, cs[4]. Both project variants. \\
  \hline
\end{tabularx}
\end{table}
