...
\begin{tabularx}{\textwidth}{|X |X |X|}
  ...
  \hline
  \multicolumn{3}{|l|}{Version of this document: V0.2} \\
  \hline
  2026-06-05 & A. Siggelkow, Claude & Simulation testbenches (uart\_tx, uart\_rx); RX FIFO pop bug fix (\texttt{rd\_data\_r} in \texttt{as\_uart\_top.sv}) \\
  \hline
\end{tabularx}
\end{table}
...
\begin{tabularx}{\textwidth}{|X |X |X|}
  ...
  \multicolumn{1}{l}{Current version: 0.2, 2026-06-05} &
  \multicolumn{1}{l|}{Author: A. Siggelkow} \\
  \multicolumn{1}{|l}{ } &
  \multicolumn{1}{l}{Previous version: 0.1, 2026-06-05} &
  \multicolumn{1}{l|}{ } \\
  \hline
  \hline
  ...
  \hline
  \multicolumn{3}{|l|}{Chapter Version: C0.2; Date: 2026-06-05} \\
  \hline
  --- & \ref{subsec:uartsimtest} / 2026-06-05 & Simulation testbenches (uart\_tx, uart\_rx); RX FIFO pop bug fix (AS, Claude) \\
  \hline
\end{tabularx}
\end{table}
