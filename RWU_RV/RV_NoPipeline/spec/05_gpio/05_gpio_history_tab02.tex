...
\begin{tabularx}{\textwidth}{|X |X |X |}
  ...
  \hline
  \ref{sec:gpiofunc01} & \ref{sec:gpiofunc01} / 2025-11-19 & Changed the BPI; removed the registers from the kernel and added them to GPIOTop. Added an interrupt. Removed the address output. changed the GPIO output to inout. (AS) \\
  \hline
\end{tabularx}
\end{table}
