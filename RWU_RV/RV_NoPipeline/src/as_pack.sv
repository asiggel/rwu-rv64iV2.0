...
package as_pack;
  ...
  // Memory map
  localparam int       dmem_start_address_c           = 64'h00000000_00000000; // byte address
  localparam int       dmem_end_address_c             = 64'h00000000_0000FFFF;
  localparam int       gpio_start_address_c           = 64'h00000001_00000000;
  ...
  localparam int       uart0_end_address_c            = 64'h00000001_0000017F; // 12 registers space
  ...
  localparam int       gpio_data_reg_addr_offs_c      = 16;
  localparam int       gpio_data_reg_addr_rst_c       = 64'h00000000_00000000;
  localparam int       gpio_irqss_reg_addr_offs_c     = 24;
  localparam int       gpio_irqss_reg_rst_c           = 64'h00000000_00000000;
  localparam int       gpio_irqsm_reg_addr_offs_c     = 32;
  localparam int       gpio_irqsm_reg_rst_c           =  64'hffffffff_ffffffff;
  localparam int       gpio_irqsc_reg_addr_offs_c     = 40;
  localparam int       gpio_irqsc_reg_rst_c           = 64'h00000000_00000000;
  localparam int       gpio_isr_reg_addr_offs_c       = 48;
  localparam int       gpio_isr_reg_rst_c             =  64'h00000000_00000000;
  localparam int       gpio_ris_reg_addr_offs_c       = 56;
  localparam int       gpio_ris_reg_rst_c             =  64'h00000000_00000000;
  localparam int       gpio_imsc_reg_addr_offs_c      = 64;
  localparam int       gpio_imsc_reg_rst_c            =  64'hffffffff_ffffffff; // change to 0 before tape-out
  localparam int       gpio_mis_reg_addr_offs_c       = 72;
  localparam int       gpio_mis_reg_rst_c             =  64'h00000000_00000000;
  // QSPI
  localparam int       qspi_id_reg_addr_offs_c        =  0;
  localparam int       qspi_id_reg_addr_rst_c         = 64'h00000000_00000010;
  localparam int       qspi_ctrl_reg_addr_offs_c      =  8; // check
  localparam int       qspi_ctrl_reg_addr_rst_c       = 64'h00000000_00000000; // check
  localparam int       qspi_cmd_reg_addr_offs_c       = 16; // check
  localparam int       qspi_cmd_reg_addr_rst_c        = 64'h00000000_00000000; // check
  localparam int       qspi_addr_reg_addr_offs_c      = 24; // check
  localparam int       qspi_addr_reg_rst_c            = 64'h00000000_00000000; // check
  localparam int       qspi_len_reg_addr_offs_c       = 32; // check
  localparam int       qspi_len_reg_rst_c             = 64'h00000000_00000000; // check
  localparam int       qspi_dummy_reg_addr_offs_c     = 40; // check
  localparam int       qspi_dummy_reg_rst_c           = 64'h00000000_00000000; // check
  localparam int       qspi_clkdiv_reg_addr_offs_c    = 48; // check
  localparam int       qspi_clkdiv_reg_rst_c          = 64'h00000000_00000000; // check
  localparam int       qspi_timeout_reg_addr_offs_c   = 56; // check
  localparam int       qspi_timeout_reg_rst_c         = 64'h00000000_00000000; // check
  localparam int       qspi_isr_reg_addr_offs_c       = 64; // check
  localparam int       qspi_isr_reg_rst_c             = 64'h00000000_00000000;
  localparam int       qspi_ris_reg_addr_offs_c       = 72; // check
  localparam int       qspi_ris_reg_rst_c             = 64'h00000000_00000000;
  localparam int       qspi_imsc_reg_addr_offs_c      = 80; // check
  localparam int       qspi_imsc_reg_rst_c            = 64'hffffffff_ffffffff;
  localparam int       qspi_mis_reg_addr_offs_c       = 88; // check
  localparam int       qspi_mis_reg_rst_c             = 64'h00000000_00000000;
  localparam int       qspi_icr_reg_addr_offs_c       = 96; // check
  localparam int       qspi_icr_reg_rst_c             = 64'h00000000_00000000;
  localparam int       qspi_rx_reg_addr_offs_c        = 104; // check
  localparam int       qspi_rx_reg_rst_c              = 64'h00000000_00000000;
  localparam int       qspi_tx_reg_addr_offs_c        = 112; // check
  localparam int       qspi_tx_reg_rst_c              = 64'h00000000_00000000;
  localparam int       qspi_fifost_reg_addr_offs_c    = 120; // check
  localparam int       qspi_fifost_reg_rst_c          = 64'h00000000_00000000;
  localparam int       qspi_xip_reg_addr_offs_c       = 128; // check
  localparam int       qspi_xip_reg_rst_c             = 64'h00000000_000000A0;
  localparam int       qspi_stat_reg_addr_offs_c      = 136; // check
  localparam int       qspi_stat_reg_rst_c            = 64'h00000000_00000000;

  localparam int       cgu_id_reg_addr_offs_c         =  0;
  localparam int       cgu_id_reg_addr_rst_c          = 64'h00000000_00000010;

  localparam int       dmem_id_reg_addr_offs_c        =  0;
  localparam int       dmem_id_reg_addr_rst_c         = 64'h00000000_00000011;
